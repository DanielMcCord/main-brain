...
/**
 * Returns an integer in the range [0, n) using cryptographic randomness.
 * Uses a the bare minimum number of bytes from the host system's entropy pool.
 * Expected runtime is O(1) if the system has enough entropy available.
 ...
 * To conserve entropy, this does not use cryptographically secure randomness,
 * unless `casino` is set to true.
 ...
 */
export function getNewCode(choices = 6, length = 4, casinoMode = false) {
